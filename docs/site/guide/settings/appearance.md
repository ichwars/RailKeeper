...
surfaces. **Compact** in v0.1.20.1 primarily tightens spacing between Settings cards; it is not a
...
| Compact does not make inventory tables denser | In v0.1.20.1 it mainly reduces gaps between Settings cards. |
