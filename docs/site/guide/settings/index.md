...
This chapter documents stable RailKeeper v0.1.19.2.
...
- Interface language is browser-local in v0.1.19.2 and is not written to the server profile.
...
6. When moving to another browser, sign in with the same user. Set the interface language again
   because language is not profile-synchronized in v0.1.19.2.
