...
This chapter describes the vehicle workflow shipped with RailKeeper v0.1.20.2.

Admin, Editor, Viewer, and Planner users can inspect the inventory. Creating, changing, and deleting
vehicle records requires Admin or Editor. In v0.1.20.2, write controls can still be visible to Viewer
...
other detail fields in v0.1.20.2. The filters below are applied in the browser to the vehicles
...
| Group | Stable v0.1.20.2 choices |
| --- | --- |
...
The **Without maintenance** label is imprecise in v0.1.20.2. It selects vehicles without a due
...
In the English locale, the table/card and refresh tooltips remain German in v0.1.20.2. This is a
...
The following choices are static in v0.1.20.2. Their stored values remain German in both UI
locales.
...
the edit-form Details section in v0.1.20.2.
...
v0.1.20.2. If no matching vehicle exists, RailKeeper does not create a report. Allow the print window
...
and designation. There is no undo or typed confirmation in v0.1.20.2.
...
This page documents the vehicle workflow shipped with RailKeeper **v0.1.20.2** and was last reviewed on 2026-08-17.
