...
to continue from an indicator to the affected vehicles. It describes stable RailKeeper v0.1.20.
...
In v0.1.20, **Without main image** technically checks whether any image exists. It does not
