...
to continue from an indicator to the affected vehicles. It describes stable RailKeeper v0.1.19.2.
...
In v0.1.19.2, **Without main image** technically checks whether any image exists. It does not
