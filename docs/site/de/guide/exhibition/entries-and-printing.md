...
**Baureihe** wird mit dem Eintrag gespeichert, erscheint in v0.1.20.1 jedoch weder in Tabelle und
...
v0.1.20.1 kann außerdem frühere Klartextwerte lesen, die durch Kommas, Semikolons oder Zeilen
...
Diese Seite beschreibt RailKeeper v0.1.20.1. Der Entwicklungsstand auf `main` kann abweichen und
