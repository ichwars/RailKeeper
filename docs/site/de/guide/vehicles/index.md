...
druckbare Reports. Dieses Kapitel beschreibt den mit RailKeeper v0.1.20.3 veröffentlichten Fahrzeugablauf.

Admin, Editor, Viewer und Planner können den Bestand einsehen. Fahrzeuge anlegen, ändern und
löschen dürfen nur Admin und Editor. In v0.1.20.3 können Schreibfunktionen für Viewer und Planner
...
Detailfelder durchsucht v0.1.20.3 nicht. Die nachfolgenden Filter wirken im Browser auf die vom
...
| Gruppe | Stabile Auswahl in v0.1.20.3 |
| --- | --- |
...
Die Bezeichnung **Ohne Wartung** ist in v0.1.20.3 ungenau. Der Filter zeigt Fahrzeuge ohne fälligen
...
Die folgenden Werte sind in v0.1.20.3 statisch. Sie bleiben in beiden Oberflächensprachen auf
Deutsch gespeichert.
...
**QR-Code erstellen** steuert in v0.1.20.3 nur die QR-Schaltfläche im Detailbereich des
...
identifizierte Fahrzeug bestätigen. v0.1.20.3 bietet weder Rückgängig noch eine Eingabebestätigung.
...
Diese Seite dokumentiert den mit RailKeeper **v0.1.20.3** veröffentlichten Fahrzeugablauf und wurde zuletzt am
17.08.2026 geprüft.
