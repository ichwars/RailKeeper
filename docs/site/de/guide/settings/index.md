...
Dieses Kapitel dokumentiert RailKeeper v0.1.20.
...
- Die Oberflächensprache ist in v0.1.20 nur im Browser gespeichert und wird nicht in das
...
6. Bei einem anderen Browser mit demselben Benutzer anmelden. Die Oberflächensprache erneut setzen,
   weil sie in v0.1.20 nicht über das Profil synchronisiert wird.
