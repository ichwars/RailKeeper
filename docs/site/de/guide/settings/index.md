...
Dieses Kapitel dokumentiert RailKeeper v0.1.20.1.
...
- Die Oberflächensprache ist in v0.1.20.1 nur im Browser gespeichert und wird nicht in das
...
6. Bei einem anderen Browser mit demselben Benutzer anmelden. Die Oberflächensprache erneut setzen,
   weil sie in v0.1.20.1 nicht über das Profil synchronisiert wird.
