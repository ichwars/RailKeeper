...
Grundfläche sowie sehr dunkle Panels. **Kompakt** verkleinert in v0.1.19.2 hauptsächlich die Abstände
...
| Kompakt verdichtet die Bestandstabellen nicht | In v0.1.19.2 verkleinert der Stil hauptsächlich Abstände zwischen Einstellungskarten. |
