...
Die Sprachwahl wird in RailKeeper v0.1.20.1 nur im aktuellen Browser gespeichert. Sie folgt dem
...
- Darf die aktuelle Rolle ein gespeichertes Ziel nicht öffnen, verwendet RailKeeper die erste
  zulässige Ansicht.
- **Anlage** ist in v0.1.20.1 auswählbar, bleibt aber ein unveröffentlichter Entwicklungsbereich und
...
RailKeeper speichert und synchronisiert beide Vorgaben. In v0.1.20.1 sind sie noch nicht mit allen
...
RailKeeper v0.1.20.1 speichert diesen Wert, leitet aber noch nicht jeden Druckvorgang automatisch an
...
Die Liste kann **Anlage** enthalten, obwohl RailKeeper v0.1.20.1 diesen Arbeitsbereich nicht in der
...
| Die Oberflächensprache unterscheidet sich auf einem anderen Gerät | Dort erneut einstellen. Die Sprache ist in v0.1.20.1 browserlokal. |
...
| Gewählter Drucker oder Datumsformat zeigen keine Wirkung | Die Vorgaben werden gespeichert, aber in v0.1.20.1 noch nicht von jedem Arbeitsablauf global verwendet. |
