...
Their labels and active states can be maintained, but v0.1.19.1 does not allow creating or deleting
...
There is no permanent-delete action in v0.1.19.1. Archive a location to retire it and reactivate it
