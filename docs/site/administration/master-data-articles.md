...
Their labels and active states can be maintained, but v0.1.20 does not allow creating or deleting
...
There is no permanent-delete action in v0.1.20. Archive a location to retire it and reactivate it
