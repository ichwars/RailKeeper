...
- [ ] **Step 3: Implement focused loading and orchestration**
...
- [ ] **Step 1: Write failing handler, role and CSRF tests**
...
- [ ] **Step 3: Implement handlers, routes and exact schemas**
...
- [ ] **Step 3: Implement focused components and responsive styling**
...
- [ ] **Step 2: Restart local server and perform browser QA**
