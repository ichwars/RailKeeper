...
func apiRouteSpecs() []routeSpec {
	return []routeSpec{
		...
		{http.MethodPut, "/api/v1/vehicle-sets/{id}/main-image", routeAccessEditor, (*App).setVehicleSetMainImage, nil},
		{http.MethodPost, "/api/v1/vehicle-sets/{id}/image", routeAccessEditor, (*App).uploadVehicleSetImage, nil},
		{http.MethodDelete, "/api/v1/vehicle-sets/{id}/image", routeAccessEditor, (*App).deleteVehicleSetImage, nil},
		{http.MethodGet, "/api/v1/vehicle-sets/{id}/image/file", routeAccessViewer, (*App).downloadVehicleSetImage, nil},
		{http.MethodGet, "/api/v1/vehicle-sets/{id}/image/thumbnail", routeAccessViewer, (*App).downloadVehicleSetImageThumbnail, nil},
		...
		{http.MethodDelete, "/api/v1/data-transfer/jobs/{id}", routeAccessAdmin, (*App).deleteDataTransferJob, nil},
