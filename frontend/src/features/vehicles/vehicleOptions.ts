...
export const vehicleConditionOptions = ["Neu", "Neuwertig", "Sehr gut", "Gut", "Gebraucht", "Leichte Gebrauchsspuren", "Reparaturbedürftig", "Defekt"];
export const packagingOptions = ["Originalverpackung", "Ersatzverpackung", "Ohne Verpackung", "Transportbox", "Sonstiges"];
export const maintenanceKinds = ["Wartung", "Reparatur", "Umbau", "Superung", "Reinigung", "Schmierung", "Decoder-Einbau", "Ersatzteiltausch"];
export const maintenanceStatuses = [
  { value: "geplant", label: "geplant" },
  { value: "faellig", label: "fällig" },
  { value: "erledigt", label: "erledigt" }
];
export const conditionRatings = ["neuwertig", "sehr gut", "gut", "gebraucht", "reparaturbedürftig"];
