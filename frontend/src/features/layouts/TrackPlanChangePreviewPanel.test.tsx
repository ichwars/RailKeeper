...
describe("TrackPlanChangePreviewPanel", () => {
  it("shows compact revision, material, issue, and configuration deltas", () => {
    ...
    expect(screen.getByText("2 Gleisänderungen")).toBeInTheDocument();
    expect(screen.getByText("2 Planobjektänderungen")).toBeInTheDocument();
