...
export const vehicleImportFields: { key: VehicleImportField; label: string }[] = [
  ...
  { key: "decoderType", label: "Decoder-Typ" },
  ...
  { key: "acquisitionType", label: "Erwerbsart" },
  { key: "acquiredFrom", label: "Erworben von/bei" },
  { key: "purchasePrice", label: "Kaufpreis" },
  { key: "purchaseDate", label: "Kaufdatum" },
  { key: "storageLocation", label: "Lagerort" },
  { key: "storageDetails", label: "Lagerdetails" },
  { key: "condition", label: "Zustand" },
  { key: "conditionDetails", label: "Zustandsdetails" },
...
export const columnAliases: Record<string, VehicleImportField> = {
  ...
  decodertyp: "decoderType",
  "decoder-typ": "decoderType",
  ...
  preis: "listPrice",
  uvp: "listPrice",
  erwerb: "acquisitionType",
  erwerbsart: "acquisitionType",
  acquisition: "acquisitionType",
  acquisitiontype: "acquisitionType",
  erworbenvon: "acquiredFrom",
  "erworbenvon-bei": "acquiredFrom",
  bezugsquelle: "acquiredFrom",
  acquiredfrom: "acquiredFrom",
  "from-at": "acquiredFrom",
  ...
  lagerdetails: "storageDetails",
  lagerplatzdetails: "storageDetails",
  storagedetails: "storageDetails",
  zustand: "condition",
  condition: "condition",
  zustandsdetails: "conditionDetails",
  zustandsbeschreibung: "conditionDetails",
  ...
  beleuchtungbeschreibung: "lightingDescription",
  ...
  "qr-codeerstellen": "qrCodeEnabled"
};
